  ...
  head: () => ({
    meta: [
      { title: "Scholarships · Project Netr" },
      {
        name: "description",
        content:
          "Scholarships for students at every stage — merit, need-based, and identity-based.",
      },
    ],
  }),
    ...
    <AppShell>
      <div className="mb-12 grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
        <PageHeader
          ...
          title={
            <>
              {t("scholarships.titlePre")}{" "}
              <span className="netr-glow-text">{t("scholarships.titleHighlight")}</span>{" "}
              {t("scholarships.titlePost")}
            </>
          }
