  ...
  head: () => ({
    meta: [
      { title: "About — Project Netr" },
      {
        name: "description",
        content:
          "About Project Netr — an AI-powered opportunity discovery platform built so every dream finds its opportunity. Created by Akshat Srivastava.",
      },
      { property: "og:title", content: "About — Project Netr" },
      {
        property: "og:description",
        content: "Why Project Netr exists, what we believe in, and the people behind it.",
      },
    ...
    <AppShell>
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          />
          <p className="mt-6 text-[11px] font-semibold uppercase tracking-[0.22em] text-saffron">
            {t("about.eyebrow")}
          </p>
          <h1 className="mt-3 font-display text-4xl font-bold tracking-tight sm:text-5xl">
            {t("about.titlePre")}{" "}
            <span className="netr-glow-text">{t("about.titleHighlight")}</span>{" "}
            {t("about.titlePost")}
          </h1>
        ...
        <div className="mt-14">
          <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.22em] text-leaf">
            {t("about.teamLabel")}
          </p>
