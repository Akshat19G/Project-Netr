...
function LanguagePage() {
  ...
  const [selected, setSelected] = useState<LangCode>((i18n.language?.slice(0, 2) as LangCode) || "en");
  ...
  return (
    <div className="min-h-screen netr-hero-bg">
      ...
      <main className="mx-auto grid max-w-6xl gap-10 px-4 pb-16 pt-4 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6 }} className="hidden lg:block">
          <img
            src={welcomeImg}
